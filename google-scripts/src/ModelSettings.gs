function modelRowToObject(m) {
  return {
    ...
    partRequirement: parseJsonSafe(m.PartRequirement, {}),
    sheetSizes: parseJsonSafe(m.SheetSizes, {}),
...
function saveModel(payload) {
  ...
  var row = {
    ...
    PartRequirement: JSON.stringify(payload.partRequirement || {}),
    SheetSizes: JSON.stringify(payload.sheetSizes || {}),
